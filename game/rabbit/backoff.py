...
def before_execution(
    ...
    `raise_exception` - True: в конце выполнения функции при неблагоприятных условиях инициализируется исключение.
                      - False: в конце выполнения функции при неблагоприятных условиях вернется None
    """
